...
public class LoggerMode {
    ...
    static volatile boolean loaded = WarningHandler.isLoaded();
    ...
    public static void loadLogger() {
        ...
        Log.logger = (level, text) -> {
            ...
            String raw = text;
            text = "[" + Utility.getDate() + "] [" + Thread.currentThread().getName() + (Thread.currentThread().getThreadGroup() != null ? "-" + Thread.currentThread().getThreadGroup().getName() : "") + (st == null || !Reflect.debug ? "" : "-" + st) + "] " + text;
            try {
            ...
            Events.fire(EventExtended.Log.class, new EventExtended.Log(raw, result, level));
