/*
8:18:47 am June 4, 2021
Generated for Mindustry: a2a4302c8c
*/
...
public class Callable {
    ...
    public void stateSnapshot(mindustry.net.NetConnection playerConnection, float waveTime, int wave, int enemies, boolean paused, boolean gameOver, int timeData, byte tps, byte[] coreData) {
        pre();
        mindustry.gen.Call.stateSnapshot(playerConnection, waveTime, wave, enemies, paused, gameOver, timeData, tps, coreData);
        post();
    }
