...
public class PlayerDiscreteMDPTensor implements MDP<PlayerObservationTensor, Integer, DiscreteSpace> {
    ...
    public PlayerDiscreteMDPTensor(PlayerObservationTensor observation, InterfaceControl interfaceControl, StateController stateController){
    ...
    public MDP<PlayerObservationTensor, Integer, DiscreteSpace> newInstance() {
        ...
        return new PlayerDiscreteMDPTensor(observation,interfaceControl, state);
    }
}
